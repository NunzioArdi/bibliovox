...
class ControleurAdmin extends Controleur
{
    ...
    public function processCreateUser()
    {
        ...
        $email = $_POST['lastname'] . "." . $_POST['firstname'] . "@bibli.com";
        try {
            Utilisateur::createUser($_POST['firstname'], $_POST['lastname'], $pwdEncode, $_POST['grade'], $email);
        } catch (\Exception $e) {
        ...
        return $this->resp->withRedirect($GLOBALS["router"]->urlFor("creerCompte"));
